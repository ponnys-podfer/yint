::  The TinyMUD/MangledMUD code often mixes contexts where we have to output
::  and cause side effects as a single method in what's otherwise a pure
::  function or a database only mutating function. This is a catchall door
